...
CREATE TABLE `credit_type` (
  ...
  `available_currency` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `fullInEnd` int(1) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `credit_type` VALUES (1,'Дифференцированный платеж',12,1,12,'1',1),(2,'Аннуитентный платеж',6,1,6,'2',0);
